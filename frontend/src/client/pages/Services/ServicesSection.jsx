...
import ConsultingImage from "/img/consulting.webp";
import DesigningImage from "/img/designing.webp";
import ContractingImage from "/img/contracting.webp";
  ...
  return (
    <section className="services-section">
      ...
      <div className="services-buttons-container">
        <button
          className={`service-button ${
            activeService === "consulting" ? "active" : ""
          }`}
        ...
        <button
          className={`service-button ${
            activeService === "designing" ? "active" : ""
          }`}
        ...
        <button
          className={`service-button ${
            activeService === "contracting" ? "active" : ""
          }`}
      ...
      <AnimatedSection animationType="slideInFromBottom">
        ...
        <p className="final-text-serviceSec">
          From start to finish, we are with you at every step
        </p>
      </AnimatedSection>
    </section>
  );

...
import solution1 from "/img/mechanical-sol.webp";
import solution2 from "/img/electrical-sol.webp";
import solution3 from "/img/plumbing-sol.webp";
import solution4 from "/img/ELV-sol.webp";
    ...
    <section className="solutions-section">
      ...
      <AnimatedSection animationType="fadeIn">
        <div
          ...
          className="solution-card mechanical"
          style={{ backgroundImage: `url(${solution1})` }}
        >
          <div className="content">
            <div className="text">
              ...
              <AnimatedSection animationType="slideInFromBottom" delay={500}>
                <p>
                  We offer innovative mechanical solutions, ensuring efficient
                  and reliable systems tailored to your project's unique
                  requirements. Our approach emphasizes sustainability and
            ...
            <AnimatedSection animationType="slideInFromRight" delay={1000}>
              <ul>
                ...
                <li>
                  Package unit air conditioning for large volume commercial
                  areas
                </li>
      ...
      <AnimatedSection animationType="fadeIn">
        <div
          ...
          className="solution-card electrical"
          style={{ backgroundImage: `url(${solution2})` }}
        >
          <div className="content">
            <div className="text">
              <AnimatedSection animationType="slideInFromLeft">
              ...
              <AnimatedSection animationType="slideInFromBottom" delay={500}>
                <p>
                  We provide comprehensive design, installation, and
                  maintenance, delivering safe and effective power
                  infrastructure for your operations. We prioritize reliability
                  and efficiency to support your energy needs.
                </p>
              </AnimatedSection>
            </div>
            <AnimatedSection animationType="slideInFromRight" delay={1000}>
      ...
      <AnimatedSection animationType="fadeIn">
        <div
          ...
          className="solution-card plumbing"
          style={{ backgroundImage: `url(${solution3})` }}
        >
          <div className="content">
            <div className="text">
              <AnimatedSection animationType="slideInFromLeft">
              ...
              <AnimatedSection animationType="slideInFromBottom" delay={500}>
                <p>
                  With advanced plumbing solutions, we ensure robust, efficient,
                  and sustainable systems for all types of projects. Our
                  expertise guarantees compliance and long-term reliability.
                </p>
              </AnimatedSection>
            </div>
            <AnimatedSection animationType="slideInFromRight" delay={1000}>
              <ul>
                ...
                <li>
                  Installation of Pumps & Tank pumps, Fittings and Accessories
                </li>
      ...
      <AnimatedSection animationType="fadeIn">
        <div
          id="elv-solutions"
          className="solution-card elv"
          style={{ backgroundImage: `url(${solution4})` }}
        >
          <div className="content">
            <div className="text">
              <AnimatedSection animationType="slideInFromLeft">
              ...
              <AnimatedSection animationType="slideInFromBottom" delay={500}>
                <p>
                  Our ELV & Data solutions enhance connectivity and security
                  through cutting-edge technology, optimizing communication and
                  IT infrastructure. We focus on seamless integration and
                  advanced features to meet your specific needs.
                </p>
              </AnimatedSection>
            </div>
            <AnimatedSection animationType="slideInFromRight" delay={1000}>
              <ul>
                ...
                <li>
                  MATV (Master Antenna Television) Systems & CCTV (Closed
      ...
      <AnimatedSection animationType="slideInFromBottom">
        ...
        <p className="final-text-solutionSec">
          Whatever you need, however you need.
        </p>
      </AnimatedSection>
    </section>
  );

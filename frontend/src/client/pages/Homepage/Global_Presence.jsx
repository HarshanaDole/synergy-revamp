    ...
    <section className="global-presence-section">
      <AnimatedSection animationType="fadeIn">
        <div className="header-container">
          <img
            src="/img/blue-globe.webp"
            alt="Global Presence Header"
          ...
          <div className="global-presence-overlay">
            <AnimatedSection animationType="slideInFromTop">
              <h2>
                GLOBAL
                <br />
                <span className="header-2">PRESENCE</span>
              </h2>
            </AnimatedSection>
            <AnimatedSection animationType="slideInFromBottom">
              <p className="description">
                We have established a robust global presence, delivering
                cutting-edge engineering solutions to clients across multiple
                continents. With a network of strategic partnerships and
                regional offices, we provide tailored services and products that
                meet the unique needs of each market. Our commitment to
                excellence and innovation ensures that we remain a trusted
